...
function EditSeatReturn(props) {
    ...
    const getData = async() => {
        ...
        const res3 = await axios.post('http://localhost:8000/adminsearchflights/', {_id: props.location.returnFlightID||res.data[0].returnFlightID})
    ...
    function handleSubmit() {
        ...
        if(!props.location.paymentAmount || props.location.paymentAmount<= 0){
            ...
            newBooking.returnFlightSeats = currentSelection;
        ...
        history.push({
            ...
            state:{
                ...
                returnFlightID: props.location.returnFlightID,
                selectedReturnSeats: currentSelection,
